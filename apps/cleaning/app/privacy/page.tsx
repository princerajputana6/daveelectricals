...
export const metadata: Metadata = {
  ...
  description:
    "How Dave Cleaning Services collects, uses, stores and protects your personal data, in accordance with UK GDPR and the Data Protection Act 2018.",
};
  ...
  return (
    <>
      <PageHero
        ...
        title="Privacy Policy"
        intro="This policy explains how Dave Cleaning Services collects, uses and protects your personal data in line with UK data protection law."
      />
        ...
        <div className="mt-10">
          <Section title="1. Who we are">
            <p>
              ...
              &ldquo;our&rdquo;) is a UK cleaning services business and the
          ...
          <Section title="4. How and why we use your data">
            ...
            <ul className="list-disc space-y-2 pl-5">
              <li>
                <strong className="text-slate-700">Contract</strong> — to provide
                quotes, carry out the cleaning work you book, issue
                certificates and invoices, and process your payments.
              </li>
              <li>
                <strong className="text-slate-700">Legal obligation</strong> — to
                keep accounting and tax records, and to retain property
                certification as required under UK regulations.
              </li>
              <li>
                <strong className="text-slate-700">Legitimate interests</strong>{" "}
                — to respond to enquiries, manage our customer relationship,
                keep records of work carried out, and prevent fraud.
              </li>
              <li>
                <strong className="text-slate-700">Consent</strong> — where you
          ...
          <Section title="5. Payments">
            <p>
              ...
              <strong className="text-slate-700">Stripe</strong>. Your full card
          ...
          <Section title="6. Who we share your data with">
            ...
            <ul className="list-disc space-y-2 pl-5">
              <li>
                <strong className="text-slate-700">Stripe</strong> — payment
                processing.
              </li>
              <li>
                <strong className="text-slate-700">Intuit QuickBooks</strong> —
              ...
              <li>
                <strong className="text-slate-700">Our hosting, database and
                file-storage providers</strong> — to run the website and store
                invoices and certificates securely.
              </li>
              <li>
                <strong className="text-slate-700">Our email provider</strong> —
          ...
          <Section title="8. How long we keep your data">
            <p>
              ...
              tax law. Cleaning quotes and booking records are
