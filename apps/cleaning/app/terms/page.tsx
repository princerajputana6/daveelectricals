...
export const metadata: Metadata = {
  ...
  description:
    "The terms and conditions (end-user agreement) governing your use of the Dave Cleaning Services website and the cleaning services we provide.",
};
  ...
  return (
    <>
      <PageHero
        ...
        title="Terms of Service"
        intro="These terms form the agreement between you and Dave Cleaning Services when you use our website or book our cleaning services."
      />
        ...
        <div className="mt-10">
          <Section title="1. About these terms">
            <p>
              ...
              &ldquo;us&rdquo;, &ldquo;our&rdquo;) and the cleaning services we
          ...
          <Section title="2. Our services">
            <p>
              We provide cleaning installation, inspection, testing,
              ...
              cleaners to the applicable UK standards and Building
              Regulations.
            </p>
          </Section>
