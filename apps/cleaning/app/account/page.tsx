  ...
  return (
    <>
      <PageHero
        ...
        intro="Track your orders, certificates and enquiries — and manage your details with Dave Cleaning Services."
      />
          ...
          <aside className="space-y-5">
            <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-7">
              ...
              <div className="relative flex items-center gap-4">
                <span className="grid h-14 w-14 place-items-center rounded-full bg-bolt font-display text-xl font-bold text-white">
                  {session.name
                    .split(" ")
                    .slice(0, 2)
                    .map((n) => n[0])
              ...
              <div className="relative mt-6 flex flex-wrap gap-3">
                <Link
                  href="/services"
                  className="group inline-flex items-center gap-2 rounded-full bg-bolt px-5 py-2.5 text-sm font-bold text-white transition-transform hover:scale-[1.04]"
                >
                  Book a service
