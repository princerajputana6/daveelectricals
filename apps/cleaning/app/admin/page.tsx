    ...
    <div className="space-y-8">
      <header>
        ...
        <p className="mt-2 text-sm text-slate-500">
          Real-time view of orders, revenue and customers across Dave Cleaning
          Services.
        </p>
      </header>
          ...
          {stats.days.map((d) => {
            ...
            return (
              <div key={d.date} className="flex flex-col items-center">
                <div className="relative flex h-40 w-full items-end gap-1 rounded-lg border border-slate-100 bg-white/50 p-1">
                  <div
      ...
      {/* Pipeline */}
      <section>
        <h2 className="font-display text-lg font-bold text-slate-900">Pipeline</h2>
      ...
      <section className="grid gap-4 sm:grid-cols-3">
        <Link
          href="/admin/orders"
          className="group flex items-center justify-between rounded-2xl border border-slate-200 bg-white p-5 transition-colors hover:border-bolt/30"
        >
          <span className="flex items-center gap-3">
            <BagIcon className="h-5 w-5 text-bolt" />
            <span className="font-semibold text-slate-900">Manage orders</span>
          </span>
          <ArrowIcon className="h-4 w-4 text-slate-500 transition-transform group-hover:translate-x-1" />
        </Link>
        <Link
        ...
        >
          <span className="flex items-center gap-3">
            ...
            <span className="font-semibold text-slate-900">Visit public site</span>
          </span>
          <ArrowIcon className="h-4 w-4 text-slate-500 transition-transform group-hover:translate-x-1" />
        </Link>
      </section>
