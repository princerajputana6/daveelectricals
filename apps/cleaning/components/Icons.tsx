...
export function SprayIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M9 8V5a1 1 0 0 1 1-1h2v4" />
      <path d="M7 8h6a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1Z" />
      <path d="M14 6h2M14 3h3M18 5h2" />
    </svg>
  );
}
...
export function BroomIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M19 3l-8 8" />
      <path d="M14 9l-8.5 8.5a2 2 0 0 0 0 2.8l.2.2 5-2 4-4-.7-5.5Z" />
