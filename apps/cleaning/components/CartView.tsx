...
export default function CartView() {
  ...
  if (count === 0) {
    return (
      <div className="rounded-3xl border border-dashed border-slate-200 bg-white/60 p-12 text-center">
        ...
        <Link
          href="/services"
          className="mt-6 inline-flex items-center gap-2 rounded-full bg-bolt px-6 py-3 font-bold text-white transition-transform hover:scale-[1.04]"
        >
          Browse services
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[1.6fr_1fr]">
            ...
            >
              ...
              <div className="flex items-center gap-1 rounded-full border border-slate-200 bg-white p-1">
                <button
                  ...
                  className="h-8 w-8 rounded-full text-bolt transition-colors hover:bg-slate-100"
                >
                  −
                </button>
                <span className="min-w-[28px] text-center font-bold text-slate-900">
                  {l.qty}
                </span>
                <button
                  onClick={() => setQty(l.productId, l.variantId, l.qty + 1)}
              ...
              <button
                ...
                className="grid h-9 w-9 place-items-center rounded-lg text-slate-500 transition-colors hover:bg-slate-100 hover:text-red-400"
              >
      ...
      <aside className="h-fit rounded-2xl border border-slate-200 bg-white p-7">
        ...
        <Link
          href="/checkout"
          className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-bolt px-5 py-3.5 font-bold text-white transition-transform hover:scale-[1.02]"
        >
