...
export default function CertificateViewer({
  ...
  return (
    <div className="relative min-h-[100svh] select-none bg-white py-24 sm:py-32">
      <style jsx global>{`
      ...
      {devtoolsOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/95 backdrop-blur-xl">
          <div className="max-w-md rounded-3xl border border-bolt/30 bg-white p-10 text-center">
      ...
      <div className="mx-auto max-w-4xl px-5 sm:px-8">
        ...
        {!fullyPaid && (
          <div className="mt-6 rounded-2xl border border-amber-500/40 bg-amber-500/10 p-5 text-amber-100">
            ...
            <Link
              href="/account"
              className="mt-4 inline-flex items-center gap-2 rounded-full bg-amber-300 px-5 py-2 text-sm font-bold text-white"
            >
        ...
        {/* CERTIFICATE BODY */}
        <div className="mt-8 overflow-hidden rounded-3xl border border-slate-200 bg-white text-slate-900 shadow-2xl">
          <div className="relative">
            ...
            >
              <div className="flex items-center justify-between border-b-4 border-bolt pb-4">
                ...
                <span className="grid h-14 w-14 place-items-center rounded-xl bg-white text-bolt">
            ...
            {!fullyPaid && (
              <div className="pointer-events-none absolute inset-0 grid place-items-center">
                <div className="rounded-2xl border-4 border-amber-500 bg-amber-500/95 px-8 py-4 font-display text-2xl font-bold tracking-wide text-white shadow-2xl sm:text-3xl">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 px-5 py-4 text-emerald-100">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="rounded-full bg-bolt px-5 py-2 text-sm font-bold text-white"
              >
                Print / Save PDF
              </button>
              {cert.fileUrl && (
