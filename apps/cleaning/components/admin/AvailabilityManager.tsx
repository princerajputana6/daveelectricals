...
const inputClass =
  "rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-900 focus:border-bolt/60 focus:outline-none focus:ring-2 focus:ring-bolt/20";
    ...
    <div className="space-y-8">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6">
        ...
        {times.length > 0 && (
          <div className="mt-4 flex flex-wrap gap-2">
            {times.map((t) => (
              <span
                key={t}
                className="flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-sm text-slate-900"
              >
                {t}
                <button
                  type="button"
        ...
        <button
          ...
          onClick={saveSlots}
          disabled={busy}
          className="mt-5 rounded-xl bg-bolt px-6 py-2.5 text-sm font-bold text-white transition-transform hover:scale-[1.02] disabled:opacity-60"
        >
