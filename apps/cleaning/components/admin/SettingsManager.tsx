...
export default function SettingsManager({
  ...
  return (
    <div className="max-w-xl rounded-2xl border border-slate-200 bg-white p-6">
      <h2 className="font-display text-lg font-bold text-slate-900">VAT rate</h2>
      ...
      <div className="mt-5 flex items-end gap-3">
        <div className="flex-1">
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 pr-9 text-sm text-slate-900 focus:border-bolt/60 focus:outline-none focus:ring-2 focus:ring-bolt/20"
            />
        ...
        <button
          ...
          onClick={save}
          disabled={busy}
          className="rounded-full bg-bolt px-6 py-3 text-sm font-bold text-white transition-transform hover:scale-[1.04] disabled:opacity-50"
        >
          {busy ? "Saving…" : "Save"}
        </button>
      </div>
