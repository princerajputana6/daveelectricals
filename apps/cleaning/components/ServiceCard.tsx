...
export default function ServiceCard({
  ...
  return (
    <motion.article
      ...
      whileHover={{ y: -6 }}
      className="group relative flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white p-7 transition-colors hover:border-bolt/40"
    >
      ...
      <div className="relative flex items-center justify-between">
        ...
        <span className="font-display text-5xl font-bold text-slate-900/5 transition-colors group-hover:text-bolt/15">
          0{index + 1}
        </span>
      </div>
