...
export default function Testimonials() {
  ...
  return (
    <div className="overflow-hidden rounded-3xl border border-slate-200 bg-[#0f1b2d]">
      <div className="grid gap-6 p-6 sm:p-8 lg:grid-cols-[240px_1fr] lg:items-center">
        ...
        >
          <p className="text-lg font-bold uppercase tracking-[0.2em] text-slate-900">
            Excellent
          </p>
          <Stars n={Math.round(rating)} className="mt-2" />
          <p className="mt-2 text-sm text-slate-600">
            Based on <span className="font-semibold text-slate-900">{count} reviews</span>
          </p>
          ...
          {reviews.map((r, i) => (
            ...
            >
              <div className="flex items-center gap-3">
                <span
                  className="grid h-10 w-10 shrink-0 place-items-center rounded-full text-base font-semibold text-slate-900"
