...
export default function TestPaymentPanel() {
  ...
  return (
    <div className="mx-auto max-w-lg rounded-2xl border border-slate-200 bg-white p-7">
      ...
      <div className="mt-6 flex items-end justify-between gap-4 border-t border-slate-200 pt-5">
        ...
        <button
          ...
          disabled={busy}
          className="group inline-flex items-center gap-2 rounded-full bg-bolt px-6 py-3 font-bold text-white transition-transform hover:scale-[1.04] disabled:opacity-60"
        >
