 ...
 * background used on the Biztreck site, recoloured to the Dave Cleaning
...
export default function WaveBackground() {
  ...
  useEffect(() => {
    ...
    const colorNear = new THREE.Color(0x14a1e6); // brand blue
    const colorFar = new THREE.Color(0xbfe3f7); // pale blue
