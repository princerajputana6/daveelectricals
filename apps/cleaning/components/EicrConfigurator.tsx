...
export default function EicrConfigurator() {
  ...
  const inputCls =
    "w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-900 focus:border-bolt/60 focus:outline-none focus:ring-2 focus:ring-bolt/20";
  const lblCls =
  ...
  return (
    <div className="relative mt-5 space-y-4">
        ...
        >
          <div>
            ...
            <select
              ...
              className={inputCls}
            >
              <option value="1ph" className="bg-white">
                Single phase
              </option>
              <option value="3ph" className="bg-white">
                3 Phase
              </option>
            </select>
          </div>
      ...
      >
        ...
        <span className="flex items-center gap-1.5 whitespace-nowrap text-xs font-bold text-slate-900">
      ...
      <div className="flex flex-wrap items-end justify-between gap-4 border-t border-slate-200 pt-5">
        <div>
          ...
          <p className="mt-0.5 flex items-center gap-1.5 text-[11px] uppercase tracking-wider text-slate-500">
  ...
  return (
    ...
    >
      <span className="flex items-center justify-between">
        <span
          className={`font-display text-sm font-bold ${active ? "text-bolt" : "text-slate-900"}`}
        >
          {label}
        </span>
        <span
