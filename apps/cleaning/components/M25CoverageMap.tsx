...
const SERVICE_PILLS = [
  ...
  { Icon: BuildingIcon, top: "Commercial", bottom: "Cleaning" },
...
export default function M25CoverageMap() {
  return (
    <div className="overflow-hidden rounded-3xl border border-bolt/30 bg-gradient-to-br from-slate-50 via-white to-slate-100 shadow-2xl shadow-bolt/10">
      {/* Top yellow ribbon */}
      <div className="bg-bolt text-white">
        <div className="mx-auto flex max-w-6xl items-center gap-3 px-6 py-3 sm:px-10">
          ...
          <p className="font-display text-lg font-extrabold uppercase tracking-tight sm:text-2xl">
            London-Wide Cleaning Services
          </p>
        </div>
        <div className="border-t border-ink/15 bg-bolt-deep">
          <p className="mx-auto max-w-6xl px-6 py-1.5 text-center text-[10px] font-bold uppercase tracking-[0.3em] text-white sm:text-[12px]">
      ...
      <div className="relative grid gap-0 lg:grid-cols-[1fr_1.4fr]">
        ...
        <div className="relative flex flex-col justify-center gap-8 border-b border-slate-200 bg-white/40 p-8 lg:border-b-0 lg:border-r lg:p-10">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.35em] text-bolt">
              Our reach
            </p>
            <h2 className="mt-2 font-display text-4xl font-extrabold leading-[0.9] tracking-tight text-slate-900 sm:text-5xl">
              COVERING <span className="block">ALL AREAS</span>
              <span className="block">WITHIN THE</span>
              <span className="mt-2 inline-block rounded-xl bg-bolt px-4 py-1 font-display text-6xl font-black text-white sm:text-7xl">
                M25
              </span>
            ...
            {SERVICE_PILLS.map(({ Icon, top, bottom }, i) => (
              ...
              >
                ...
                <div className="leading-tight">
                  <p className="font-display text-sm font-bold uppercase tracking-wide text-slate-900">
                    {top}
                  </p>
      ...
      <div className="grid gap-0 border-t border-slate-200 bg-white/80 sm:grid-cols-2">
        <div className="flex items-center gap-3 border-b border-slate-200 px-6 py-4 sm:border-b-0 sm:border-r">
          <span className="grid h-10 w-10 shrink-0 place-items-center rounded-lg bg-bolt/10 text-bolt ring-1 ring-bolt/30">
            <ShieldIcon className="h-5 w-5" />
          </span>
          <div className="leading-tight">
            <p className="font-display text-sm font-extrabold uppercase tracking-wide text-slate-900">
        ...
        <div className="flex items-center gap-3 px-6 py-4">
          <span className="grid h-10 w-10 shrink-0 place-items-center rounded-lg bg-bolt text-white">
      ...
      <div className="bg-bolt">
        <div className="mx-auto flex max-w-6xl items-center justify-center gap-3 px-6 py-3 text-white sm:px-10">
          <BoltIcon className="h-5 w-5" />
