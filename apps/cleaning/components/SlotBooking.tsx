  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[1.4fr_1fr]">
      <div className="rounded-3xl border border-slate-200 bg-white p-7 sm:p-9">
        ...
        <div className="mt-6">
          {loading ? (
            <p className="rounded-2xl border border-slate-200 bg-white/60 p-6 text-center text-sm text-slate-500">
                      ...
                      return (
                        <button
                          ...
                          className={`rounded-xl border px-4 py-2.5 text-sm font-semibold transition-all ${
                            s.booked
                              ? "cursor-not-allowed border-slate-100 bg-white/[0.02] text-slate-500 line-through"
                              : isSelected
                                ? "border-bolt bg-bolt text-white"
                                : "border-slate-200 bg-white text-slate-900 hover:border-bolt/50"
                          }`}
      ...
      <aside className="h-fit space-y-5">
        ...
        >
          ...
          {selectedSlot ? (
            ...
            <p className="mt-1 text-sm text-slate-500">Pick a slot to continue.</p>
          )}
          ...
          {user ? (
            <div className="mt-5 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Briefly describe the cleaning emergency…"
                  className={`${inputClass} resize-none`}
                />
              </div>
            ...
            <div className="mt-5 rounded-xl border border-bolt/20 bg-bolt/5 p-4 text-sm text-slate-500">
              ...
              <Link
                ...
                className="mt-3 inline-flex items-center gap-2 rounded-full bg-bolt px-5 py-2.5 text-sm font-bold text-white"
              >
                Sign in to continue
