...
export const services = [
  {
    ...
    short: "Refurbishments, wiring and full re-wiring for homes and businesses.",
    body:
      "Undertaking a refurbishment project can be a challenging and sometimes daunting experience. Various surprises can and will crop up along the way. At Dave Electrical, we take into account the many surprises which will inevitably occur. Wiring a house is a specialist undertaking — and one we handle with precision, planning and care.",
    points: [
      "Residential refurbishments",
      "Wiring and full re-wiring",
  ...
  },
  {
    ...
    short: "The services partner of choice for businesses across London.",
    body:
      "Dave Electrical is a services company of choice for many commercial clients. Our work is highly-regarded by our cherished clients and we make every effort to keep them satisfied. Our expert electricians are reliable and trustworthy, and consistently aim to secure the best possible testimonial on each and every assignment.",
    points: [
      "Office & retail fit-outs",
      "Restaurant & hospitality electrics",
      "Planned maintenance contracts",
      "Reliable, vetted electricians",
    ],
  },
  {
    slug: "certification",
    icon: "shield",
    title: "Certification, Inspection & Testing",
    short: "Meet your legal obligations with full compliance certification.",
    body:
      "Inspection & Testing is a legal requirement in the UK. Beyond regulation, frequent inspection of your electrical systems is a critical factor in day-to-day health, safety and productivity. At Dave Electrical we assist you in meeting your legal obligations, and provide periodic reports for peace of mind — industrial, commercial and domestic testing for insurance, councils, HMOs or to comply with the Electricity at Work Regulations.",
    points: [
  ...
  },
  {
    slug: "callouts",
    icon: "clock",
    title: "24 Hour Emergency Call-Outs",
    short: "A fully manned 24/7, 365-days-a-year electrical call-out service.",
    body:
      "With 24 hour electrical service call-outs, Dave Electrical proudly offers a full manned call-out service for all electrical services. We are only ever a phone call away from fixing your electrical issue — no matter the time of day or month of the year. From common repairs like light fittings and sockets to commercial properties, air conditioning systems and main supplies, we strive to get the power back up and running.",
    points: [
  ...
  },
  {
    ...
    points: [
      ...
      "Full weekly / 6-monthly / 3-yearly testing",
  ...
  },
  {
    ...
    short: "Fully trained CCTV engineers — installation, tailored to your needs.",
    body:
      "Dave Electrical have CCTV installations engineers and technicians that are fully trained and qualified to provide the best quality workmanship and advice. We'll tailor every installation to meet your security requirements as well as your budget and business restrictions, and you can be rest assured that all the equipment we supply is of the highest quality. We offer free quotations for all new analogue and digital CCTV home security installations and can attend your property on the same day of your phone call.",
    points: [
  ...
  },
  {
    ...
    body:
      "Dave Electrical have EV charger installation engineers and technicians that are fully trained and qualified to provide the best quality workmanship and advice. We'll tailor every installation to meet your security requirements as well as your budget and business restrictions, and you can be rest assured that all the equipment we supply is of the highest quality. We offer free quotations for all EV charging installations and can attend your property on the same day of your phone call.",
    points: [
